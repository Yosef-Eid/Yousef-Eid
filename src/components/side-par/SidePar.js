...
function SideBar() {
  ...
  let styleIcon = "flex flex-col items-center justify-center text-[23px] max-[400px]:text-[22px] cursor-pointe w-10 h-10 max-[400px]:w-8 max-[400px]:h-8 rounded-xl max-[400px]:bg-white bg-gray-100 min-[400px]:hover:bg-[#ffb400]  min-[400px]:hover:text-white hover:text-[#faa000] cursor-pointer transition-all delay-75 ease-out "
  return (
